...
// Réponse question 8 :
SELECT champions."name", positions."name" FROM champions,champion_position,positions WHERE champions.champion_id = champion_position.champion_id AND champion_position.position_id = positions.position_id;
